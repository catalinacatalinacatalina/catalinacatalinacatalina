...
Hi, I'm **Catalina**. I am a Computer Engineering student at the **Universidad Complutense de Madrid**, and this space is like an album of my learning, creative moments, and technical progress. Feel free to explore, learn, fork, and open issues if necessary.

> ⚠️ Note to the reader: this is a creative journal. You will find mistakes, weird changes, sometimes NOT efficient implementations (especially in older projects), but there are still a thousand things to discover. This is a canvas, made to paint on, to experiment with.
---
